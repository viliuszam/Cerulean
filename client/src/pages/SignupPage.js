...
const SignupPage = () => {
    ...
    return (
        <Container>
            <FormWrapper>
                <Title>
                    Sign up to Cerulean <Icon icon={heartIcon} color="#007acc" width="24" height="24" /> <Icon icon={cartIcon} color="#007acc" width="24" height="24" />
                </Title>
                <Formik
                ...
                >
                    {({ isSubmitting, status }) => (
                        <Form>
                            ...
                            <InputField>
                                <Icon icon={nameIcon} width="20" height="20" />
                                <StyledField type="text" name="realName" placeholder="Full Name" />
                            </InputField>
                            <ErrorMessage name="realName" component={ErrorText} />
                            <InputField>
                                <Icon icon={emailIcon} width="20" height="20" />
